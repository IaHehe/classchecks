package com.classchecks.client.student.api.login.vo;
...
public class StudentVo {
	...
	public StudentVo(Integer id, String securityAccount, String securitSmsCode, Integer faceLabel, String jwAccount,
			int securitType) {
		super();
		this.id = id;
